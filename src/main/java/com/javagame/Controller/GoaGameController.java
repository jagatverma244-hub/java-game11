...
@Controller
@RequestMapping("/Goa")
public class GoaGameController {

    @Autowired
    private GoaBetRepo betRepo;
    ...
    @Autowired
    private GoaHarupBetRepository harupBetRepo;
    ...
    public String showGamePage(Model model) {
        ...
        return "/user/goa/Goagame";  // game.html
    }
    ...
    public String placeGame1Bet(@ModelAttribute BetRequest betRequest,
        ...
        if (user.getWalletBalance() < betRequest.getAmount()) {
            ...
            return "redirect:/Goa/Goagame";
        }

        GoaBet bet = new GoaBet();
        bet.setUser(user);
    ...
    public String showHarupPage(Model model) {
        model.addAttribute("betRequest", new BetRequest());
        return "/user/goa/gameharup";  // gameharup.html
    }
    ...
    public String placeHarupBet(@ModelAttribute BetRequest betRequest, Model model) {
        ...
        GoaharupBet harupBet = new GoaharupBet();
